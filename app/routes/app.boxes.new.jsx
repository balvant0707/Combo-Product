...
export default function CreateBoxPage() {
  ...
  function confirmColl() {
    ...
    collProdsFetchers[stepIdx].load(
      withEmbeddedAppParams(`/app/boxes/new?collectionId=${encodeURIComponent(tempColls[0].id)}`, location.search)
    );
