          ...
          <div style={{ ...modalBoxStyle, maxWidth: "520px" }}>
            ...
            <div style={modalBodyStyle}>
              {filteredColls.length === 0 ? (
                ...
                return (
                  <div key={coll.id} onClick={() => setTempColl(isSel ? null : coll)} style={{ display: "flex", alignItems: "center", gap: "12px", padding: "10px 16px", borderBottom: idx < filteredColls.length - 1 ? "1px solid #f3f4f6" : "none", cursor: "pointer", background: isSel ? "#f0f7ff" : "#fff", transition: "background 0.1s", userSelect: "none" }}>
