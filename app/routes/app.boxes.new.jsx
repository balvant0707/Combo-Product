...
export default function CreateBoxLayout() {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: "20px", borderRadius: "5px", background: "linear-gradient(135deg, #091fd6 0%, #c11a10 55%, #706cd3 100%)", boxShadow: "0 8px 32px rgba(9,31,214,0.22)", overflow: "hidden", position: "relative", padding: "24px 32px" }}>
        ...
        <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "rgba(255,255,255,0.15)", backdropFilter: "blur(4px)", borderRadius: "999px", padding: "4px 14px", fontSize: "10px", fontWeight: "800", letterSpacing: "0.10em", textTransform: "uppercase", color: "#d1fae5", marginBottom: "10px" }}>📦 New Box</div>
      ...
      <div style={{ display: "flex", borderBottom: "2px solid #e5e7eb", marginBottom: "20px" }}>
        {[
          { label: "📋 Box Settings",       path: withEmbeddedAppParams("/app/boxes/new",       location.search), active: !isCombo },
          { label: "🎯 Specific Combo Box", path: withEmbeddedAppParams("/app/boxes/new/combo", location.search), active: isCombo  },
        ].map((tab) => (
          <button
            key={tab.label}
